  ...
  head: () => ({
    meta: [
      ...
      { title: "Parallelism — Lesson 3 Geometry Study Guide" },
      {
        name: "description",
        content:
          "Interactive English study guide for Lesson 3: Parallelism — angle pairs, parallel-line relations, proofs, exercises and learning games.",
      },
      { property: "og:title", content: "Parallelism — Lesson 3 Geometry Study Guide" },
      {
        property: "og:description",
        content: "Angle pairs, proofs, exercises and interactive games for parallel lines.",
      },
